...
#define TURN_TARGET_TICKS90 215
#define DRIVE_TARGET_TICKS 250
...

{
    ...
    while (1)
    {
        ...
        case SETUP_BUMPEDOUTSIDE2: //Not used
             state  = WAIT;
        break;
